...
Feature: Inward Payment flow feature
  ...
  Scenario Outline: Inward Payment flow
    ...
    And user validate whether payment move to QueuedToAccountVerification status using "<ValueDateperiod>","<PaymentType>","<Reference>","<SubRef>","<ChequeNo>","<AccountNumber>","<gpkey>"
    ...
    Examples: 
      ...
      |                 | ACH CHEQUE RECEIVE | Cheque No | EQUAL  | 30002168 |               |
